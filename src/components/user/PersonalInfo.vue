<template>
  <ul class="list-group" >
    <li class="list-group-item" >
      <p class="fs-4 fw-semibold" style="margin-top: 0.5rem; margin-bottom: 0.5rem;">Personal Info</p>
      <p>
    ...
    <li class="list-group-item">
      <p class="fs-5 fw-semibold" style="margin-top: 0.5rem; margin-bottom: 0rem;">My Info</p>
